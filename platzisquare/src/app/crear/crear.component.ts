...
export class CrearComponent {
  ...
  constructor(
    ...
    seleccionarDireccion(direccion) {
      //Nota: asi podemos buscar la latitud y longitud y pasarla inmediatamente
      console.log(direccion);
      this.lugar.calle = direccion.formatted_address;
      this.lugar.ciudad = direccion.address_components[0].long_name;
      this.lugar.pais = direccion.address_components[2].long_name;
    }
